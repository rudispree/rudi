        ...
        <a href="/proseslogout" class="logout">
            ...
            <div id="user-detail">
                ...
                <div id="user-info">
                    ...
                    <span id="user-role">{{Auth::guard('karyawan')->user()->jabatan}}</span><br>
            ...
            <div class="card">
                <div class="card-body text-center">
                    <div class="list-menu">
                        ...
                        <div class="item-menu text-center">
                            <div class="menu-icon">
                                <a href="/presensi/buatizin" class="danger" style="font-size: 40px;">
                        ...
                        <div class="card" style="margin-top:10px;">
                                <div class="card-body"  >
                                    <div class="historicontent">
                                        ...
                                        <h3>{{ date('d-m-Y', strtotime($d->tgl_presensi)) }}</h3>
                                        <span>
