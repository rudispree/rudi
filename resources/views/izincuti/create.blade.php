        ...
        <div class="col">
            ...
            <form method="post" action="/izincuti/store" id="frmIzin">
                ...
                <div class="form-group">
                    <input type="text" id="tgl_izin_dari" autocomplete="off" class="form-control datepicker" name="tgl_izin_dari" placeholder="Dari">
                 </div>
                 <div class="form-group">
                    <input type="text" id="tgl_izin_sampai" class="form-control datepicker" name="tgl_izin_sampai" placeholder="Sampai">
                 </div>
                <div class="form-group">
                    <input type="text" id="jml_hari" class="form-control" name="jml_hari" placeholder="Jumlah Hari" readonly>
                 </div>
                <div class="form-group">
                    <select name="kode_cuti_karyawan" id="kode_cuti_karyawan" class="form-control selectmaterialize">
...
//   });
  ...
  $("#frmIzin").submit(function(){
     ...
     var kode_cuti_karyawan = $("#kode_cuti_karyawan").val(); 
