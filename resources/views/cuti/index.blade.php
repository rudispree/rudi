        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Cuti Karyawan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                 ...
                 <tbody>
                     ...
                     @foreach ($cuti as $d)
                        ...
                        <tr>
                            ...
                            <td>{{ $d->nama_cuti }}</td>
                            <td>{{ $d->jml_hari }}</td>
                            <td>{{ $tgl_izin_dari . ' - ' . $tgl_izin_sampai }}</td>
                            <td>
                           
                              <a href="#" kode_cuti="{{ $d->kode_cuti }}" class="edit">
                              ...
                              <form action="/cuti/{{ $d->kode_cuti }}/delete" method="POST" enctype="multipart/form-data">
                              @csrf
                              <!-- @method('DELETE') -->
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Form Tambah Data Cuti</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div> 
          <div class="modal-body">
          <form action="/cuti/store" method="POST" enctype="multipart/form-data" style="margin-top:1rem" id="frmCuti">
          @csrf
           
            <div class="mb-3">
              <label class="form-label">Nama Cuti</label>
              <input type="text" class="form-control" name="nama_cuti" placeholder="Nama Cuti" id="nama_cuti" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Jumlah Hari</label>
              <input type="text" class="form-control" name="jml_hari" placeholder="Jumlah Hari" id="jml_hari" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Dari Tanggal</label>
              <input type="date" class="form-control" name="tgl_izin_dari" placeholder="Dari Tanggal" id="tgl_izin_dari" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Sampai Tanggal</label>
              <input type="date" class="form-control" name="tgl_izin_sampai" placeholder="Sampai Tanggal" id="tgl_izin_sampai" required>
            </div>
