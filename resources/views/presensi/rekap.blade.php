...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rekap Presensi Data Karyawan Karyawan</h1>
          </div>
          <div class="col-sm-6">
            ...
            <form action="/presensi/cetakrekap" target="_blank" method="POST">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button  type="submit" name="exportexcel" class="btn btn-success btn-lg btn-block"><i class="fa fa-download" aria-hidden="true"></i> Download Data</button>
                        </div>
                    </div>
