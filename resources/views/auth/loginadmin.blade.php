  ...
  <body  class=" d-flex flex-column bg-white">
    ...
    <div class="row g-0 flex-fill">
      <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
        <div class="container container-tight my-5 px-lg-5">
          ...
          <div class="text-center mb-4">
            <a href="." class="navbar-brand navbar-brand-autodark"><img src="https://lspdigitalmarketing.id/wp-content/uploads/2022/03/Asset-1-1536x946.png" class="imgl"  alt=""></a>
          </div>
          @php 
          ...
          @if (Session::get('warning'))
              <div class="alert alert-outline-danger">
                     <p class="text-red"> {{$messagewarning}}</p>
              </div>
      ...
      <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
        <!-- Photo -->
        <div class="bg-cover h-100 min-vh-100" style="background-image: url({{asset('tabler/4207.jpg')}})"></div>
      </div>
    </div>
    <!-- Libs JS -->
    <!-- Tabler Core -->
